...
export const SETTINGS_DEFAULTS: SiteSettings = {
  ...
  // Stats bar
  stat1_value: '6',
  stat1_label: 'Disponible rapidement',
  stat2_value: '120 km',
  stat2_label: "Jusqu'à 120 km",
  stat3_value: '60 MAD',
  stat3_label: 'À partir de 60 MAD',
  stat4_value: '7j/7',
  stat4_label: 'Assistance 7j/7',
  // Pricing cards
  price1_duration: 'Quelques heures',
  price1_price: '60',
  price1_features: 'Casque fourni|Assistance disponible|Parfait pour les trajets rapides',
  price2_duration: 'La journée',
  price2_price: '170',
  price2_features: 'Casque et antivol inclus|Assistance disponible|Pensé pour profiter de Marrakech',
  price3_duration: 'La semaine',
  price3_price: '950',
  price3_features: 'Équipements inclus|Support prioritaire|Location prolongeable',
  // Visuals
  marker_icon_url: '',
  formule1_image_url: '',
  formule2_image_url: '',
